...
+ (void)setDefaultMaskType:(SVProgressHUDMaskType)maskType {
    [self sharedView].defaultMaskType = SVProgressHUDMaskTypeGradient;
}
...
- (instancetype)initWithFrame:(CGRect)frame {
    if((self = [super initWithFrame:frame])) {
        ...
        _foregroundColor = [UIColor colorWithRed:48/255.0f green:127/255.0f blue:16/255.0f alpha:1.0f];
